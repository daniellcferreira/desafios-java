...
import task.board.dto.BoardColumnInfoDTO;
import task.board.exception.CardBlockedException;
import task.board.exception.CardFinishedException;
import task.board.exception.EntityNotFoundException;
import task.board.persistence.dao.BlockDAO;
import task.board.persistence.dao.CardDAO;
import task.board.persistence.entity.CardEntity;

import static task.board.persistence.entity.BoardColumnKindEnum.CANCEL;
import static task.board.persistence.entity.BoardColumnKindEnum.FINAL;
